...
**Status:** Foundation spec **plus executable backend (S0–S15)** in this monorepo.
...
2. `implementation/BACKEND_IMPLEMENTATION_STATUS.md` — what was built for the backend (S0–S15).
